 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1770__maximum-score-from-performing-multiplication-operations/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Maximum Score from Performing Multiplication Operations' problem
 */
