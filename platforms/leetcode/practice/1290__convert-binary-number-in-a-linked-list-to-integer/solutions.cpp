 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1290__convert-binary-number-in-a-linked-list-to-integer/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Convert Binary Number in a Linked List to Integer' problem
 */
