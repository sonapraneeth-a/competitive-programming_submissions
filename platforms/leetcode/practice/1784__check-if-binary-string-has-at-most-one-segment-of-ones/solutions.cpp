 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1784__check-if-binary-string-has-at-most-one-segment-of-ones/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Check if Binary String Has at Most One Segment of Ones' problem
 */
