 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1779__find-nearest-point-that-has-the-same-x-or-y-coordinate/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Find Nearest Point That Has the Same X or Y Coordinate' problem
 */
