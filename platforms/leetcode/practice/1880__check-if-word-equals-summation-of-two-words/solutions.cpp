 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1880__check-if-word-equals-summation-of-two-words/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Check if Word Equals Summation of Two Words' problem
 */
