 ...
 * FILE DESCRIPTION
 *
 *        Filename: 865__smallest-subtree-with-all-the-deepest-nodes/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Smallest Subtree with all the Deepest Nodes' problem
 */
