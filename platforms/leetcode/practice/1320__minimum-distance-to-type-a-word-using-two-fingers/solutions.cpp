 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1320__minimum-distance-to-type-a-word-using-two-fingers/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Minimum Distance to Type a Word Using Two Fingers' problem
 */
