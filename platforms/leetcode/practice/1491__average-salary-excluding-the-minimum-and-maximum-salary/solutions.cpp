 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1491__average-salary-excluding-the-minimum-and-maximum-salary/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Average Salary Excluding the Minimum and Maximum Salary' problem
 */
