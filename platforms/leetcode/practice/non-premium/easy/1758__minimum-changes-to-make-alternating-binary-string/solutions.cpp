 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1758__minimum-changes-to-make-alternating-binary-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Minimum Changes To Make Alternating Binary String' problem
 */
