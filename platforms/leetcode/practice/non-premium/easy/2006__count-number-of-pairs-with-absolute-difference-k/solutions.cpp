 ...
 * FILE DESCRIPTION
 *
 *        Filename: 2006__count-number-of-pairs-with-absolute-difference-k/solutions.cpp
 *      Created on: 19 September 2021
 *   Last modified: 19 September 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Count Number of Pairs With Absolute Difference K' problem
 */
