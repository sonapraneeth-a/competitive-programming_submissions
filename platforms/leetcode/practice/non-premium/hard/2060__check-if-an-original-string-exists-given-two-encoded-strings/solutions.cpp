 ...
 * FILE DESCRIPTION
 *
 *        Filename: 2060__check-if-an-original-string-exists-given-two-encoded-strings/solutions.cpp
 *      Created on: 03 November 2021
 *   Last modified: 03 November 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Check if an Original String Exists Given Two Encoded Strings' problem
 */
