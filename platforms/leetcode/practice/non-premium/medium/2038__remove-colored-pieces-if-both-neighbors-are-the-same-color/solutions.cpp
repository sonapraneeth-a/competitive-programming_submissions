 ...
 * FILE DESCRIPTION
 *
 *        Filename: 2038__remove-colored-pieces-if-both-neighbors-are-the-same-color/solutions.cpp
 *      Created on: 03 November 2021
 *   Last modified: 03 November 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Remove Colored Pieces if Both Neighbors are the Same Color' problem
 */
