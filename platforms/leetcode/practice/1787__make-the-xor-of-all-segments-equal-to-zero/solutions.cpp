 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1787__make-the-xor-of-all-segments-equal-to-zero/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Make the XOR of All Segments Equal to Zero' problem
 */
