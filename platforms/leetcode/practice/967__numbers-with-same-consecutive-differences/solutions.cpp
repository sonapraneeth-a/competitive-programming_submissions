 ...
 * FILE DESCRIPTION
 *
 *        Filename: 967__numbers-with-same-consecutive-differences/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Numbers With Same Consecutive Differences' problem
 */
