 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1888__minimum-number-of-flips-to-make-the-binary-string-alternating/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Minimum Number of Flips to Make the Binary String Alternating' problem
 */
