 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1637__widest-vertical-area-between-two-points-containing-no-points/solutions.cpp
 *      Created on: 27 August 2021
 *   Last modified: 27 August 2021
 *          Author: sonapraneeth_a
 *     Description: LeetCode submission for 'Widest Vertical Area Between Two Points Containing No Points' problem
 */
