 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1463__split-digits-to-sum-closest-to-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Split Digits to Sum Closest To Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/split-digits-to-sum-closest-to-target/submissions/
 * Status:
