 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1278__split-list-to-minimize-largest-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Split List to Minimize Largest Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/split-list-to-minimize-largest-sum/submissions/
 * Status:
