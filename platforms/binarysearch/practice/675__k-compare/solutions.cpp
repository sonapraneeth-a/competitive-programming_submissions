 ...
 * FILE DESCRIPTION
 *
 *        Filename: 675__k-compare/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'K Compare' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/k-compare/submissions/
 * Status:
