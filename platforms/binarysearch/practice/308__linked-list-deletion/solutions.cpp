 ...
 * FILE DESCRIPTION
 *
 *        Filename: 308__linked-list-deletion/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Linked List Deletion' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/linked-list-deletion/submissions/
 * Status:
