 ...
 * FILE DESCRIPTION
 *
 *        Filename: 699__skip-tasks-to-minimize-work/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Skip Tasks to Minimize Work' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/skip-tasks-to-minimize-work/submissions/
 * Status:
