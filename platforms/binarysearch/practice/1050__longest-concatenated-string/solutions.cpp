 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1050__longest-concatenated-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Concatenated String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-concatenated-string/submissions/
 * Status:
