 ...
 * FILE DESCRIPTION
 *
 *        Filename: 395__a-number-and-its-triple/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'A Number and Its Triple' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/a-number-and-its-triple/submissions/
 * Status:
