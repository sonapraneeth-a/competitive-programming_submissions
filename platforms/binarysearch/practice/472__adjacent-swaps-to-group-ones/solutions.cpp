 ...
 * FILE DESCRIPTION
 *
 *        Filename: 472__adjacent-swaps-to-group-ones/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Adjacent Swaps to Group Ones' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/adjacent-swaps-to-group-ones/submissions/
 * Status:
