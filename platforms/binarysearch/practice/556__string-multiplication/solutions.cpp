 ...
 * FILE DESCRIPTION
 *
 *        Filename: 556__string-multiplication/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'String Multiplication' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/string-multiplication/submissions/
 * Status:
