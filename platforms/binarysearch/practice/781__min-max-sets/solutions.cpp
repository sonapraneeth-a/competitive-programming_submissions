 ...
 * FILE DESCRIPTION
 *
 *        Filename: 781__min-max-sets/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Min Max Sets' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/min-max-sets/submissions/
 * Status:
