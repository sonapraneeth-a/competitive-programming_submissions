 ...
 * FILE DESCRIPTION
 *
 *        Filename: 503__weekly-contest/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Weekly Contest' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/weekly-contest/submissions/
 * Status:
 ...
 */
// clang-format on
int solve(vector<int>& points, vector<int>& chances, int k) {
