 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1177__search-engine/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Search Engine' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/search-engine/submissions/
 * Status:
