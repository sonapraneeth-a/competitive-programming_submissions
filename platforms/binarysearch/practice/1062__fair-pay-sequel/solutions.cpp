 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1062__fair-pay-sequel/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Fair Pay Sequel' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/fair-pay-sequel/submissions/
 * Status:
 ...
 */
// clang-format on
double solve(vector<int>& performance, vector<int>& costs, int k) {
