 ...
 * FILE DESCRIPTION
 *
 *        Filename: 540__copy-paste/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Copy Paste' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/copy-paste/submissions/
 * Status:
