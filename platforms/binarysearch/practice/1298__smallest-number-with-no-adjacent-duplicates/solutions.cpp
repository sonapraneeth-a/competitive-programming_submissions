 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1298__smallest-number-with-no-adjacent-duplicates/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Smallest Number With No Adjacent Duplicates' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/smallest-number-with-no-adjacent-duplicates/submissions/
 * Status:
