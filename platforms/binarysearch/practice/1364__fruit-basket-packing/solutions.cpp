 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1364__fruit-basket-packing/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Fruit Basket Packing' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/fruit-basket-packing/submissions/
 * Status:
 ...
 */
// clang-format on
int solve(vector<vector<int>>& fruits, int k, int capacity) {
