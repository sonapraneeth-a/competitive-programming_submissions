 ...
 * FILE DESCRIPTION
 *
 *        Filename: 222__toeplitz-matrix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Toeplitz Matrix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/toeplitz-matrix/submissions/
 * Status:
