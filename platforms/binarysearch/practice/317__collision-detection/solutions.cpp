 ...
 * FILE DESCRIPTION
 *
 *        Filename: 317__collision-detection/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Collision Detection' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/collision-detection/submissions/
 * Status:
 ...
 */
// clang-format on
bool solve(vector<vector<int>>& polygon, int x, int y) {
