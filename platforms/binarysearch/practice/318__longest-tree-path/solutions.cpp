 ...
 * FILE DESCRIPTION
 *
 *        Filename: 318__longest-tree-path/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Tree Path' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-tree-path/submissions/
 * Status:
