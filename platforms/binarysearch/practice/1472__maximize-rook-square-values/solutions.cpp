 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1472__maximize-rook-square-values/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Maximize Rook Square Values' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/maximize-rook-square-values/submissions/
 * Status:
