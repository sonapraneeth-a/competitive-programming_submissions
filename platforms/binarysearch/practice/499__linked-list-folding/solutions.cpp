 ...
 * FILE DESCRIPTION
 *
 *        Filename: 499__linked-list-folding/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Linked List Folding' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/linked-list-folding/submissions/
 * Status:
