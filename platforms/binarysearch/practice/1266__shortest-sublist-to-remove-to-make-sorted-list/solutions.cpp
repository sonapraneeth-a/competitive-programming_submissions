 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1266__shortest-sublist-to-remove-to-make-sorted-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Shortest Sublist to Remove to Make Sorted List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/shortest-sublist-to-remove-to-make-sorted-list/submissions/
 * Status:
