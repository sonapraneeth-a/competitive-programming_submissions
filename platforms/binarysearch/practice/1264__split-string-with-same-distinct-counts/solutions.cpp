 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1264__split-string-with-same-distinct-counts/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Split String with Same Distinct Counts' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/split-string-with-same-distinct-counts/submissions/
 * Status:
