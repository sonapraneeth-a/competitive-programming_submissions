 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1521__minimize-maximum-stadium-size/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimize Maximum Stadium Size' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimize-maximum-stadium-size/submissions/
 * Status:
