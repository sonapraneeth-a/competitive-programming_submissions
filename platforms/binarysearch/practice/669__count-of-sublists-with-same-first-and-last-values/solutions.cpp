 ...
 * FILE DESCRIPTION
 *
 *        Filename: 669__count-of-sublists-with-same-first-and-last-values/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Count of Sublists with Same First and Last Values' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/count-of-sublists-with-same-first-and-last-values/submissions/
 * Status:
