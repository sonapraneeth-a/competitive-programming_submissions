 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1157__double-string-concatenation/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Double String Concatenation' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/double-string-concatenation/submissions/
 * Status:
