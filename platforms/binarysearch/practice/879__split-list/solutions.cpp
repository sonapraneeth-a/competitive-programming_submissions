 ...
 * FILE DESCRIPTION
 *
 *        Filename: 879__split-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Split List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/split-list/submissions/
 * Status:
