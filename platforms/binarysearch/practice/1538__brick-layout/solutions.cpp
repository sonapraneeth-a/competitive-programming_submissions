 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1538__brick-layout/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Brick Layout' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/brick-layout/submissions/
 * Status:
 ...
 */
// clang-format on
int solve(vector<int>& bricks, int width, int height) {
