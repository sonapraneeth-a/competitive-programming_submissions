 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1255__range-query-on-a-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Range Query on a List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/range-query-on-a-list/submissions/
 * Status:
