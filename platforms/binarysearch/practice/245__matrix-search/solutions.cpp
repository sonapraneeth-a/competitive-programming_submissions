 ...
 * FILE DESCRIPTION
 *
 *        Filename: 245__matrix-search/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Matrix Search' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/matrix-search/submissions/
 * Status:
