 ...
 * FILE DESCRIPTION
 *
 *        Filename: 342__justify-text/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Justify Text' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/justify-text/submissions/
 * Status:
