 ...
 * FILE DESCRIPTION
 *
 *        Filename: 961__parallel-coin-collection/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Parallel Coin Collection' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/parallel-coin-collection/submissions/
 * Status:
