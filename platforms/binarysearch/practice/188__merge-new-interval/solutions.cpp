 ...
 * FILE DESCRIPTION
 *
 *        Filename: 188__merge-new-interval/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Merge New Interval' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/merge-new-interval/submissions/
 * Status:
