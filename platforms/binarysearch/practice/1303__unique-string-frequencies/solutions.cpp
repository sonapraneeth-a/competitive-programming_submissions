 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1303__unique-string-frequencies/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Unique String Frequencies' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/unique-string-frequencies/submissions/
 * Status:
