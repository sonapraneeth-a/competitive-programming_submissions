 ...
 * FILE DESCRIPTION
 *
 *        Filename: 440__index-into-an-infinite-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Index Into an Infinite String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/index-into-an-infinite-string/submissions/
 * Status:
