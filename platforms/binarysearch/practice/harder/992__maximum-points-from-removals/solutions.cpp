 ...
 * FILE DESCRIPTION
 *
 *        Filename: 992__maximum-points-from-removals/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Maximum Points From Removals' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/maximum-points-from-removals/submissions/
 * Status:
