 ...
 * FILE DESCRIPTION
 *
 *        Filename: 569__outstanding-move-sequel/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Outstanding Move Sequel' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/outstanding-move-sequel/submissions/
 * Status:
