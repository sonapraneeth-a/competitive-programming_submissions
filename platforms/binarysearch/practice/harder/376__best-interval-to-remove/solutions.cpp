 ...
 * FILE DESCRIPTION
 *
 *        Filename: 376__best-interval-to-remove/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Best Interval to Remove' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/best-interval-to-remove/submissions/
 * Status:
