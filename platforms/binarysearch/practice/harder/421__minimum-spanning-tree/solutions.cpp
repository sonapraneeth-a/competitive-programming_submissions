 ...
 * FILE DESCRIPTION
 *
 *        Filename: 421__minimum-spanning-tree/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimum Spanning Tree' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimum-spanning-tree/submissions/
 * Status:
