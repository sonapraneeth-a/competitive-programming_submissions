 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1262__lazy-run-length-decoding/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Lazy Run-Length Decoding' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/lazy-run-length-decoding/submissions/
 * Status:
