 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1347__sliding-window-product/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Sliding Window Product' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/sliding-window-product/submissions/
 * Status:
