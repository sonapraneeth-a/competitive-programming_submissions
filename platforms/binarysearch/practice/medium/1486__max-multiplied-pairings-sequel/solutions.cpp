 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1486__max-multiplied-pairings-sequel/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Max Multiplied Pairings Sequel' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/max-multiplied-pairings-sequel/submissions/
 * Status:
