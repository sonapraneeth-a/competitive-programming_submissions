 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1403__next-node-on-its-right/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Next Node on Its Right' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/next-node-on-its-right/submissions/
 * Status:
