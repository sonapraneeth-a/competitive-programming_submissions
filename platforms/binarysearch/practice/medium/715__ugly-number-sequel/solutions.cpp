 ...
 * FILE DESCRIPTION
 *
 *        Filename: 715__ugly-number-sequel/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Ugly Number Sequel' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/ugly-number-sequel/submissions/
 * Status:
