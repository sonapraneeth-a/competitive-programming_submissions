 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1442__trail-to-minimize-effort/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Trail to Minimize Effort' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/trail-to-minimize-effort/submissions/
 * Status:
