 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1374__update-list-sum-closest-to-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Update List Sum Closest to Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/update-list-sum-closest-to-target/submissions/
 * Status:
