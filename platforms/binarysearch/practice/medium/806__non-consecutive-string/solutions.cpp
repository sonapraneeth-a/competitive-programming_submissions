 ...
 * FILE DESCRIPTION
 *
 *        Filename: 806__non-consecutive-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Non-Consecutive String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/non-consecutive-string/submissions/
 * Status:
