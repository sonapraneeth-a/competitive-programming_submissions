 ...
 * FILE DESCRIPTION
 *
 *        Filename: 780__equalize-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Equalize List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/equalize-list/submissions/
 * Status:
