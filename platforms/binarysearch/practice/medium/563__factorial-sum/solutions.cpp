 ...
 * FILE DESCRIPTION
 *
 *        Filename: 563__factorial-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Factorial Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/factorial-sum/submissions/
 * Status:
