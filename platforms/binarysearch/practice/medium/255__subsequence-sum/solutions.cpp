 ...
 * FILE DESCRIPTION
 *
 *        Filename: 255__subsequence-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Subsequence Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/subsequence-sum/submissions/
 * Status:
