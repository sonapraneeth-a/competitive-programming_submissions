 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1360__multiple-coin-flips/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Multiple Coin Flips' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/multiple-coin-flips/submissions/
 * Status:
 ...
 */
// clang-format on
double solve(vector<double>& chances, int target) {
