 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1120__pair-matches-larger-than-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Pair Matches Larger Than Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/pair-matches-larger-than-target/submissions/
 * Status:
