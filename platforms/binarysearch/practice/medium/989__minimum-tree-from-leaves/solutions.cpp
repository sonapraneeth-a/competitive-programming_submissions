 ...
 * FILE DESCRIPTION
 *
 *        Filename: 989__minimum-tree-from-leaves/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimum Tree From Leaves' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimum-tree-from-leaves/submissions/
 * Status:
