 ...
 * FILE DESCRIPTION
 *
 *        Filename: 300__convert-to-full-binary-tree/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Convert to Full Binary Tree' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/convert-to-full-binary-tree/submissions/
 * Status:
