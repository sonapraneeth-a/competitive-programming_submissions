 ...
 * FILE DESCRIPTION
 *
 *        Filename: 140__zero-matrix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Zero Matrix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/zero-matrix/submissions/
 * Status:
