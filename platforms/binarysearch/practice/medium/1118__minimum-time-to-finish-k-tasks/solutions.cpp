 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1118__minimum-time-to-finish-k-tasks/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimum Time to Finish K Tasks' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimum-time-to-finish-k-tasks/submissions/
 * Status:
