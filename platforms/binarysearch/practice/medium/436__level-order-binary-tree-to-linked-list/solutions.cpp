 ...
 * FILE DESCRIPTION
 *
 *        Filename: 436__level-order-binary-tree-to-linked-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Level Order Binary Tree to Linked List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/level-order-binary-tree-to-linked-list/submissions/
 * Status:
