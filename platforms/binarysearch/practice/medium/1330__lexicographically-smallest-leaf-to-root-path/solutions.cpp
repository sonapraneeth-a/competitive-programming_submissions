 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1330__lexicographically-smallest-leaf-to-root-path/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Lexicographically Smallest Leaf to Root Path' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/lexicographically-smallest-leaf-to-root-path/submissions/
 * Status:
