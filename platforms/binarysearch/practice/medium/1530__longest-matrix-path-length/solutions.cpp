 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1530__longest-matrix-path-length/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Matrix Path Length' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-matrix-path-length/submissions/
 * Status:
