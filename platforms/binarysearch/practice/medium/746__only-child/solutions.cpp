 ...
 * FILE DESCRIPTION
 *
 *        Filename: 746__only-child/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Only Child' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/only-child/submissions/
 * Status:
