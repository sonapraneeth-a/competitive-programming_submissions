 ...
 * FILE DESCRIPTION
 *
 *        Filename: 382__all-sublists-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'All Sublists Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/all-sublists-sum/submissions/
 * Status:
