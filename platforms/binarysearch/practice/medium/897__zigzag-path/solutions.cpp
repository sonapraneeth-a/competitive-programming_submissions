 ...
 * FILE DESCRIPTION
 *
 *        Filename: 897__zigzag-path/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'ZigZag Path' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/zigzag-path/submissions/
 * Status:
