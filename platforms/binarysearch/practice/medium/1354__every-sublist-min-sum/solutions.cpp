 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1354__every-sublist-min-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Every Sublist Min Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/every-sublist-min-sum/submissions/
 * Status:
