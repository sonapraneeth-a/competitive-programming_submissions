 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1504__dropped-sensor-metric/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Dropped Sensor Metric' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/dropped-sensor-metric/submissions/
 * Status:
