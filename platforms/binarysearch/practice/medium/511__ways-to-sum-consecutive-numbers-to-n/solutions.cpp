 ...
 * FILE DESCRIPTION
 *
 *        Filename: 511__ways-to-sum-consecutive-numbers-to-n/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Ways to Sum Consecutive Numbers to N' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/ways-to-sum-consecutive-numbers-to-n/submissions/
 * Status:
