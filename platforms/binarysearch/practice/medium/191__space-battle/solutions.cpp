 ...
 * FILE DESCRIPTION
 *
 *        Filename: 191__space-battle/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Space Battle' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/space-battle/submissions/
 * Status:
