 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1421__three-player-coin-game/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Three Player Coin Game' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/three-player-coin-game/submissions/
 * Status:
