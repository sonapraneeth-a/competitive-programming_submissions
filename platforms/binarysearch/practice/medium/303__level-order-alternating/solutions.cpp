 ...
 * FILE DESCRIPTION
 *
 *        Filename: 303__level-order-alternating/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Level Order Alternating' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/level-order-alternating/submissions/
 * Status:
