 ...
 * FILE DESCRIPTION
 *
 *        Filename: 835__set-split/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Set Split' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/set-split/submissions/
 * Status:
