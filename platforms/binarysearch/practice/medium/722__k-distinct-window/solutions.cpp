 ...
 * FILE DESCRIPTION
 *
 *        Filename: 722__k-distinct-window/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'K Distinct Window' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/k-distinct-window/submissions/
 * Status:
