 ...
 * FILE DESCRIPTION
 *
 *        Filename: 667__list-consecutive-split/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'List Consecutive Split' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/list-consecutive-split/submissions/
 * Status:
