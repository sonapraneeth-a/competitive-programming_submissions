 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1528__subtree-with-maximum-value/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Subtree with Maximum Value' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/subtree-with-maximum-value/submissions/
 * Status:
