 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1328__lexicographically-smallest-string-of-distance-k/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Lexicographically Smallest String of Distance K' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/lexicographically-smallest-string-of-distance-k/submissions/
 * Status:
