 ...
 * FILE DESCRIPTION
 *
 *        Filename: 642__flipped-matrix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Flipped Matrix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/flipped-matrix/submissions/
 * Status:
