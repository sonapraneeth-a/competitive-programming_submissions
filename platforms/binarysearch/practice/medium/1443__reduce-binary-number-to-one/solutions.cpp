 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1443__reduce-binary-number-to-one/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Reduce Binary Number to One' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/reduce-binary-number-to-one/submissions/
 * Status:
