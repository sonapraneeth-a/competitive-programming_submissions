 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1268__almost-same-strings/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Almost Same Strings' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/almost-same-strings/submissions/
 * Status:
