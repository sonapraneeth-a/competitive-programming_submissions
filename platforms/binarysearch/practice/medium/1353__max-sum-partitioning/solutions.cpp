 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1353__max-sum-partitioning/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Max Sum Partitioning' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/max-sum-partitioning/submissions/
 * Status:
