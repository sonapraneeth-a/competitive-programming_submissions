 ...
 * FILE DESCRIPTION
 *
 *        Filename: 898__lexicographically-bigger-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Lexicographically Bigger String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/lexicographically-bigger-string/submissions/
 * Status:
