 ...
 * FILE DESCRIPTION
 *
 *        Filename: 345__largest-tree-sum-path/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Largest Tree Sum Path' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/largest-tree-sum-path/submissions/
 * Status:
