 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1127__lexicographically-smallest-non-palindromic-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Lexicographically Smallest Non-Palindromic String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/lexicographically-smallest-non-palindromic-string/submissions/
 * Status:
