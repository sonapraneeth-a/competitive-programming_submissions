 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1007__delete-from-the-ends-and-reinsert-to-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Delete From the Ends and Reinsert to Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/delete-from-the-ends-and-reinsert-to-target/submissions/
 * Status:
