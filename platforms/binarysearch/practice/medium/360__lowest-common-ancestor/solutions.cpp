 ...
 * FILE DESCRIPTION
 *
 *        Filename: 360__lowest-common-ancestor/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Lowest Common Ancestor' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/lowest-common-ancestor/submissions/
 * Status:
