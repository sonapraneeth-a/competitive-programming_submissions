 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1341__meeting-schedule-for-two-people/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Meeting Schedule For Two People' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/meeting-schedule-for-two-people/submissions/
 * Status:
 ...
 */
// clang-format on
vector<int> solve(vector<vector<int>>& a, vector<vector<int>>& b, int duration) {
