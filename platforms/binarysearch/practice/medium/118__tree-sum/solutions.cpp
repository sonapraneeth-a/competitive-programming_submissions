 ...
 * FILE DESCRIPTION
 *
 *        Filename: 118__tree-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Tree Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/tree-sum/submissions/
 * Status:
