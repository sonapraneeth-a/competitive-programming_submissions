 ...
 * FILE DESCRIPTION
 *
 *        Filename: 4__hoppable/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Hoppable' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/hoppable/submissions/
 * Status:
