 ...
 * FILE DESCRIPTION
 *
 *        Filename: 521__range-update/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Range Update' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/range-update/submissions/
 * Status:
