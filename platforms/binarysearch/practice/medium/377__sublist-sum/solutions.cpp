 ...
 * FILE DESCRIPTION
 *
 *        Filename: 377__sublist-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Sublist Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/sublist-sum/submissions/
 * Status:
