 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1074__team-voting/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Team Voting' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/team-voting/submissions/
 * Status:
 ...
 */
// clang-format on
string solve(vector<string>& votes) {
