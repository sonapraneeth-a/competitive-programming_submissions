 ...
 * FILE DESCRIPTION
 *
 *        Filename: 325__maximum-non-adjacent-tree-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Maximum Non-Adjacent Tree Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/maximum-non-adjacent-tree-sum/submissions/
 * Status:
