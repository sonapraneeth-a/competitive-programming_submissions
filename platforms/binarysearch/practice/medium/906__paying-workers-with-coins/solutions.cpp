 ...
 * FILE DESCRIPTION
 *
 *        Filename: 906__paying-workers-with-coins/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Paying Workers With Coins' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/paying-workers-with-coins/submissions/
 * Status:
 ...
 */
// clang-format on
int solve(vector<int>& coins, vector<int>& salaries) {
