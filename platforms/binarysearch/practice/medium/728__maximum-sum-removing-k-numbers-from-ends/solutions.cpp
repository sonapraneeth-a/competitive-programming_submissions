 ...
 * FILE DESCRIPTION
 *
 *        Filename: 728__maximum-sum-removing-k-numbers-from-ends/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Maximum Sum Removing K Numbers From Ends' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/maximum-sum-removing-k-numbers-from-ends/submissions/
 * Status:
