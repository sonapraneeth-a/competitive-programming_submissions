 ...
 * FILE DESCRIPTION
 *
 *        Filename: 2__balanced-brackets/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Balanced Brackets' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/balanced-brackets/submissions/
 * Status:
