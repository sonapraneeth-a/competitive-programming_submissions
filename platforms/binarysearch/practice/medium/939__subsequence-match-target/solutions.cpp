 ...
 * FILE DESCRIPTION
 *
 *        Filename: 939__subsequence-match-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Subsequence Match Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/subsequence-match-target/submissions/
 * Status:
