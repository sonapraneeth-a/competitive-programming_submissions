 ...
 * FILE DESCRIPTION
 *
 *        Filename: 848__grammar-rules/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Grammar Rules' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/grammar-rules/submissions/
 * Status:
