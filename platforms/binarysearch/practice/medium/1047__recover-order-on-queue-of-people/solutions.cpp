 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1047__recover-order-on-queue-of-people/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Recover Order on Queue of People' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/recover-order-on-queue-of-people/submissions/
 * Status:
 ...
 */
// clang-format on
vector<vector<int>> solve(vector<vector<int>>& queue) {
