 ...
 * FILE DESCRIPTION
 *
 *        Filename: 651__lone-integer/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Lone Integer' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/lone-integer/submissions/
 * Status:
