 ...
 * FILE DESCRIPTION
 *
 *        Filename: 622__2048/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for '2048' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/2048/submissions/
 * Status:
 ...
 */
// clang-format on
vector<vector<int>> solve(vector<vector<int>>& board, string direction) {
