 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1251__window-queries/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Window Queries 👻' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/window-queries/submissions/
 * Status:
