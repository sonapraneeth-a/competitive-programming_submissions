 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1368__common-reachable-node/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Common Reachable Node' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/common-reachable-node/submissions/
 * Status:
