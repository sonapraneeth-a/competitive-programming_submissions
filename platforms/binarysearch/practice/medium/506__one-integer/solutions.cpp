 ...
 * FILE DESCRIPTION
 *
 *        Filename: 506__one-integer/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'One Integer' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/one-integer/submissions/
 * Status:
