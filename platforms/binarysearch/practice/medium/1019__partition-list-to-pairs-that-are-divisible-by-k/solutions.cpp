 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1019__partition-list-to-pairs-that-are-divisible-by-k/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Partition List to Pairs that Are Divisible by K' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/partition-list-to-pairs-that-are-divisible-by-k/submissions/
 * Status:
