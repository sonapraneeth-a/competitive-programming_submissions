 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1397__minimum-dropping-path-sum-with-column-distance-constraint/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimum Dropping Path Sum With Column Distance Constraint' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimum-dropping-path-sum-with-column-distance-constraint/submissions/
 * Status:
