 ...
 * FILE DESCRIPTION
 *
 *        Filename: 483__leaves-in-same-level/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Leaves in Same Level' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/leaves-in-same-level/submissions/
 * Status:
