 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1539__border-crossing/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Border Crossing' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/border-crossing/submissions/
 * Status:
