 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1270__sum-of-two-numbers-with-sorted-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Sum of Two Numbers with Sorted List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/sum-of-two-numbers-with-sorted-list/submissions/
 * Status:
