 ...
 * FILE DESCRIPTION
 *
 *        Filename: 674__k-prefix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'K Prefix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/k-prefix/submissions/
 * Status:
