 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1384__complete-an-arithmetic-sequence/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Complete an Arithmetic Sequence' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/complete-an-arithmetic-sequence/submissions/
 * Status:
