 ...
 * FILE DESCRIPTION
 *
 *        Filename: 948__column-flips-to-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Column Flips to Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/column-flips-to-target/submissions/
 * Status:
