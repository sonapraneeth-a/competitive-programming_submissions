 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1407__count-substrings-with-all-1s/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Count Substrings With All 1s' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/count-substrings-with-all-1s/submissions/
 * Status:
