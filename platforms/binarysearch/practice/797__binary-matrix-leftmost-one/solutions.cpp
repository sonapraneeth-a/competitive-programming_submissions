 ...
 * FILE DESCRIPTION
 *
 *        Filename: 797__binary-matrix-leftmost-one/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Binary Matrix Leftmost One' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/binary-matrix-leftmost-one/submissions/
 * Status:
