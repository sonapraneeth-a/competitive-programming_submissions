 ...
 * FILE DESCRIPTION
 *
 *        Filename: 127__set-bits/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Set Bits' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/set-bits/submissions/
 * Status:
