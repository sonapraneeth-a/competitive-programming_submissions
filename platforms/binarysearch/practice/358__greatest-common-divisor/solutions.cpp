 ...
 * FILE DESCRIPTION
 *
 *        Filename: 358__greatest-common-divisor/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Greatest Common Divisor' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/greatest-common-divisor/submissions/
 * Status:
