 ...
 * FILE DESCRIPTION
 *
 *        Filename: 610__list-equality-with-increments/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'List Equality with Increments' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/list-equality-with-increments/submissions/
 * Status:
