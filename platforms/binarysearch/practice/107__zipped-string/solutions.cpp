 ...
 * FILE DESCRIPTION
 *
 *        Filename: 107__zipped-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Zipped String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/zipped-string/submissions/
 * Status:
