 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1412__manipulate-bits-to-zero/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Manipulate Bits to Zero' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/manipulate-bits-to-zero/submissions/
 * Status:
