 ...
 * FILE DESCRIPTION
 *
 *        Filename: 276__complete-binary-tree/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Complete Binary Tree' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/complete-binary-tree/submissions/
 * Status:
