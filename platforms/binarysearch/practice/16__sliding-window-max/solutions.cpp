 ...
 * FILE DESCRIPTION
 *
 *        Filename: 16__sliding-window-max/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Sliding Window Max' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/sliding-window-max/submissions/
 * Status:
