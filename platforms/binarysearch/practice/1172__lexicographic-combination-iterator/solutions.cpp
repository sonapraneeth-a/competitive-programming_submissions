 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1172__lexicographic-combination-iterator/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Lexicographic Combination Iterator' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/lexicographic-combination-iterator/submissions/
 * Status:
...
class LexicographicCombinationIterator {
    public:
    LexicographicCombinationIterator(string s, int k) {
