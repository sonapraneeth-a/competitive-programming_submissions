 ...
 * FILE DESCRIPTION
 *
 *        Filename: 428__partition-tree/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Partition Tree' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/partition-tree/submissions/
 * Status:
