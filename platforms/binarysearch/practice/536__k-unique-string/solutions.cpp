 ...
 * FILE DESCRIPTION
 *
 *        Filename: 536__k-unique-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'K Unique String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/k-unique-string/submissions/
 * Status:
