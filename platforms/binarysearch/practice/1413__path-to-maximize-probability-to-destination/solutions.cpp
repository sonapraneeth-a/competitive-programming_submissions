 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1413__path-to-maximize-probability-to-destination/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Path to Maximize Probability to Destination' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/path-to-maximize-probability-to-destination/submissions/
 * Status:
