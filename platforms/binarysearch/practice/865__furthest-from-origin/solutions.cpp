 ...
 * FILE DESCRIPTION
 *
 *        Filename: 865__furthest-from-origin/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Furthest From Origin' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/furthest-from-origin/submissions/
 * Status:
