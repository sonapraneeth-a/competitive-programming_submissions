 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1474__bounded-square-sums/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Bounded Square Sums' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/bounded-square-sums/submissions/
 * Status:
