 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1302__first-to-count-to-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'First to Count to Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/first-to-count-to-target/submissions/
 * Status:
