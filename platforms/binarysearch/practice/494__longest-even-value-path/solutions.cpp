 ...
 * FILE DESCRIPTION
 *
 *        Filename: 494__longest-even-value-path/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Even Value Path' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-even-value-path/submissions/
 * Status:
