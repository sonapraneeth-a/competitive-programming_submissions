 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1338__rate-limiter/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Rate Limiter' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/rate-limiter/submissions/
 * Status:
