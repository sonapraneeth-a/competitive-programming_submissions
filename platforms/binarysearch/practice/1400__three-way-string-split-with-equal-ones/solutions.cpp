 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1400__three-way-string-split-with-equal-ones/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Three-Way String Split with Equal Ones' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/three-way-string-split-with-equal-ones/submissions/
 * Status:
