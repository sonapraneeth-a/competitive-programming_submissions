 ...
 * FILE DESCRIPTION
 *
 *        Filename: 278__sum-tree/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Sum Tree' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/sum-tree/submissions/
 * Status:
