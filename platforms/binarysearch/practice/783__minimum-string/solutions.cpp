 ...
 * FILE DESCRIPTION
 *
 *        Filename: 783__minimum-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimum String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimum-string/submissions/
 * Status:
