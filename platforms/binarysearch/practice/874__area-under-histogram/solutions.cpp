 ...
 * FILE DESCRIPTION
 *
 *        Filename: 874__area-under-histogram/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Area Under Histogram' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/area-under-histogram/submissions/
 * Status:
