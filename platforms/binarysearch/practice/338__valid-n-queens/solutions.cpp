 ...
 * FILE DESCRIPTION
 *
 *        Filename: 338__valid-n-queens/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Valid N Queens' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/valid-n-queens/submissions/
 * Status:
