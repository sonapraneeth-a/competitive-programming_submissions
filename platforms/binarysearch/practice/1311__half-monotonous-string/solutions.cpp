 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1311__half-monotonous-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Half Monotonous String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/half-monotonous-string/submissions/
 * Status:
