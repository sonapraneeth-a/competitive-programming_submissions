 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1275__binary-sublist-with-target-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Binary Sublist with Target Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/binary-sublist-with-target-sum/submissions/
 * Status:
