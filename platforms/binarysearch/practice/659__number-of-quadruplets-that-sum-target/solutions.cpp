 ...
 * FILE DESCRIPTION
 *
 *        Filename: 659__number-of-quadruplets-that-sum-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Number of Quadruplets That Sum Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/number-of-quadruplets-that-sum-target/submissions/
 * Status:
