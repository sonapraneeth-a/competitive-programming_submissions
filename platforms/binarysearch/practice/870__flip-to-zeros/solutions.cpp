 ...
 * FILE DESCRIPTION
 *
 *        Filename: 870__flip-to-zeros/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Flip to Zeros' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/flip-to-zeros/submissions/
 * Status:
