 ...
 * FILE DESCRIPTION
 *
 *        Filename: 7__special-product-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Special Product List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/special-product-list/submissions/
 * Status:
