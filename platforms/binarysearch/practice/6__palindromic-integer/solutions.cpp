 ...
 * FILE DESCRIPTION
 *
 *        Filename: 6__palindromic-integer/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Palindromic Integer' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/palindromic-integer/submissions/
 * Status:
