 ...
 * FILE DESCRIPTION
 *
 *        Filename: 372__common-words/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Common Words' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/common-words/submissions/
 * Status:
