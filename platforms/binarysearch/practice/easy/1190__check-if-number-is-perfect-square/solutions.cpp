 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1190__check-if-number-is-perfect-square/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Check if Number Is Perfect Square' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/check-if-number-is-perfect-square/submissions/
 * Status:
