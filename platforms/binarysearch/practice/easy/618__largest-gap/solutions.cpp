 ...
 * FILE DESCRIPTION
 *
 *        Filename: 618__largest-gap/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Largest Gap' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/largest-gap/submissions/
 * Status:
