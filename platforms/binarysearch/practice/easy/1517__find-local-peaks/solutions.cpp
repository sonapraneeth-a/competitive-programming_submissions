 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1517__find-local-peaks/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Find Local Peaks' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/find-local-peaks/submissions/
 * Status:
