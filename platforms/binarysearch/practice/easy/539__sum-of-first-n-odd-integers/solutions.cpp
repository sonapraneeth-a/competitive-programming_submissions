 ...
 * FILE DESCRIPTION
 *
 *        Filename: 539__sum-of-first-n-odd-integers/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Sum of First N Odd Integers' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/sum-of-first-n-odd-integers/submissions/
 * Status:
