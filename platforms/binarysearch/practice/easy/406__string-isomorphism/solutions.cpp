 ...
 * FILE DESCRIPTION
 *
 *        Filename: 406__string-isomorphism/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'String Isomorphism' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/string-isomorphism/submissions/
 * Status:
