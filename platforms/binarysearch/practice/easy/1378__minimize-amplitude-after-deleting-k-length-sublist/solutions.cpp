 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1378__minimize-amplitude-after-deleting-k-length-sublist/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimize Amplitude After Deleting K-Length Sublist 🎄' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimize-amplitude-after-deleting-k-length-sublist/submissions/
 * Status:
