 ...
 * FILE DESCRIPTION
 *
 *        Filename: 62__compress-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Compress String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/compress-string/submissions/
 * Status:
