 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1182__equalize-list-sums-with-minimal-updates/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Equalize List Sums with Minimal Updates' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/equalize-list-sums-with-minimal-updates/submissions/
 * Status:
