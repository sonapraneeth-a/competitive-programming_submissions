 ...
 * FILE DESCRIPTION
 *
 *        Filename: 63__rotation-of-another-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Rotation of Another String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/rotation-of-another-string/submissions/
 * Status:
