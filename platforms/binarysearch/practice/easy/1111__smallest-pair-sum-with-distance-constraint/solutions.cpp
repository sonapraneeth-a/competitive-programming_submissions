 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1111__smallest-pair-sum-with-distance-constraint/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Smallest Pair Sum with Distance Constraint' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/smallest-pair-sum-with-distance-constraint/submissions/
 * Status:
