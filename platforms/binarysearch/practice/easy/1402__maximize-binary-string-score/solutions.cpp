 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1402__maximize-binary-string-score/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Maximize Binary String Score' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/maximize-binary-string-score/submissions/
 * Status:
