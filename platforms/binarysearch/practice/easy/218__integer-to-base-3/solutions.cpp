 ...
 * FILE DESCRIPTION
 *
 *        Filename: 218__integer-to-base-3/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Integer to Base 3' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/integer-to-base-3/submissions/
 * Status:
