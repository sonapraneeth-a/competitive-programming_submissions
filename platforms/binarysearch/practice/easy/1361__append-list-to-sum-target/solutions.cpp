 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1361__append-list-to-sum-target/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Append List to Sum Target' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/append-list-to-sum-target/submissions/
 * Status:
