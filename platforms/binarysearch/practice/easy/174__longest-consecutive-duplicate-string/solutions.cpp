 ...
 * FILE DESCRIPTION
 *
 *        Filename: 174__longest-consecutive-duplicate-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Consecutive Duplicate String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-consecutive-duplicate-string/submissions/
 * Status:
