 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1247__monotonous-string-groups/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Monotonous String Groups 🎃' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/monotonous-string-groups/submissions/
 * Status:
