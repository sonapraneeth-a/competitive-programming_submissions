 ...
 * FILE DESCRIPTION
 *
 *        Filename: 203__detect-the-only-duplicate-in-a-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Detect the Only Duplicate in a List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/detect-the-only-duplicate-in-a-list/submissions/
 * Status:
