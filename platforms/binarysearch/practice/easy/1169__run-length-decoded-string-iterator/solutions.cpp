 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1169__run-length-decoded-string-iterator/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Run-Length Decoded String Iterator' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/run-length-decoded-string-iterator/submissions/
 * Status:
