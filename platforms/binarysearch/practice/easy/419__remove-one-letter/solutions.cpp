 ...
 * FILE DESCRIPTION
 *
 *        Filename: 419__remove-one-letter/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Remove One Letter' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/remove-one-letter/submissions/
 * Status:
