 ...
 * FILE DESCRIPTION
 *
 *        Filename: 456__narcissistic-number/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Narcissistic Number' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/narcissistic-number/submissions/
 * Status:
