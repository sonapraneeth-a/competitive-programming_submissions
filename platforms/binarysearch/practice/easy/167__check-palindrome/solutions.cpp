 ...
 * FILE DESCRIPTION
 *
 *        Filename: 167__check-palindrome/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Check Palindrome' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/check-palindrome/submissions/
 * Status:
