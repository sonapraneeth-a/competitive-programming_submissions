 ...
 * FILE DESCRIPTION
 *
 *        Filename: 943__longest-interval-containing-one-number/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Interval Containing One Number' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-interval-containing-one-number/submissions/
 * Status:
