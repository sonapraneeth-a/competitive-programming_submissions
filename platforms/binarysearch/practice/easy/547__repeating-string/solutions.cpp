 ...
 * FILE DESCRIPTION
 *
 *        Filename: 547__repeating-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Repeating String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/repeating-string/submissions/
 * Status:
