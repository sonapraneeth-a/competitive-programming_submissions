 ...
 * FILE DESCRIPTION
 *
 *        Filename: 571__string-construction/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'String Construction' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/string-construction/submissions/
 * Status:
