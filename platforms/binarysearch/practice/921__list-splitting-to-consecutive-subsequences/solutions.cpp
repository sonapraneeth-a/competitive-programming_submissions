 ...
 * FILE DESCRIPTION
 *
 *        Filename: 921__list-splitting-to-consecutive-subsequences/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'List Splitting to Consecutive Subsequences' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/list-splitting-to-consecutive-subsequences/submissions/
 * Status:
