 ...
 * FILE DESCRIPTION
 *
 *        Filename: 772__bit-sum/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Bit Sum' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/bit-sum/submissions/
 * Status:
