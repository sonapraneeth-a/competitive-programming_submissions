 ...
 * FILE DESCRIPTION
 *
 *        Filename: 205__paint-bucket/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Paint Bucket' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/paint-bucket/submissions/
 * Status:
