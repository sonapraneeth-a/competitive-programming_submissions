 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1061__flip-and-invert-matrix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Flip and Invert Matrix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/flip-and-invert-matrix/submissions/
 * Status:
