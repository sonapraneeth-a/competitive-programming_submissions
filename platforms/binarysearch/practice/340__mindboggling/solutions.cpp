 ...
 * FILE DESCRIPTION
 *
 *        Filename: 340__mindboggling/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Mindboggling' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/mindboggling/submissions/
 * Status:
 ...
 */
// clang-format on
int solve(vector<vector<string>>& matrix, vector<string>& words) {
