 ...
 * FILE DESCRIPTION
 *
 *        Filename: 607__longest-common-prefix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Common Prefix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-common-prefix/submissions/
 * Status:
