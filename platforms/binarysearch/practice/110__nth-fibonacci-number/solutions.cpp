 ...
 * FILE DESCRIPTION
 *
 *        Filename: 110__nth-fibonacci-number/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Nth Fibonacci Number' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/nth-fibonacci-number/submissions/
 * Status:
