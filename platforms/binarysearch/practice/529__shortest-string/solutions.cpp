 ...
 * FILE DESCRIPTION
 *
 *        Filename: 529__shortest-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Shortest String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/shortest-string/submissions/
 * Status:
