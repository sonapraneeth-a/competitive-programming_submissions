 ...
 * FILE DESCRIPTION
 *
 *        Filename: 719__minimum-sum-subsequence/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimum Sum Subsequence' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimum-sum-subsequence/submissions/
 * Status:
