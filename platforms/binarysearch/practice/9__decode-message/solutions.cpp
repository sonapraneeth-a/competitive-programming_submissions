 ...
 * FILE DESCRIPTION
 *
 *        Filename: 9__decode-message/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Decode Message' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/decode-message/submissions/
 * Status:
