 ...
 * FILE DESCRIPTION
 *
 *        Filename: 496__longest-even-sum-path/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Even Sum Path' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-even-sum-path/submissions/
 * Status:
