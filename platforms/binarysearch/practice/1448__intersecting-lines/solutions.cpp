 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1448__intersecting-lines/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Intersecting Lines' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/intersecting-lines/submissions/
 * Status:
 ...
 */
// clang-format on
int solve(vector<vector<int>>& lines, int lo, int hi) {
