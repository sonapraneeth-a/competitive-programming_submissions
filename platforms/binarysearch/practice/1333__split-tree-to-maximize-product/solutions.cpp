 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1333__split-tree-to-maximize-product/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Split Tree to Maximize Product' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/split-tree-to-maximize-product/submissions/
 * Status:
