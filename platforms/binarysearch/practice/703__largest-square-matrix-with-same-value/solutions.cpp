 ...
 * FILE DESCRIPTION
 *
 *        Filename: 703__largest-square-matrix-with-same-value/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Largest Square Matrix with Same Value' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/largest-square-matrix-with-same-value/submissions/
 * Status:
