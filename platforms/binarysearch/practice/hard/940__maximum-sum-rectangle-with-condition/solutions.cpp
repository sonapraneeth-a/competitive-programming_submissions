 ...
 * FILE DESCRIPTION
 *
 *        Filename: 940__maximum-sum-rectangle-with-condition/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Maximum Sum Rectangle with Condition' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/maximum-sum-rectangle-with-condition/submissions/
 * Status:
