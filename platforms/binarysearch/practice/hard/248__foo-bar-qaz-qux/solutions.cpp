 ...
 * FILE DESCRIPTION
 *
 *        Filename: 248__foo-bar-qaz-qux/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Foo Bar Qaz Qux' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/foo-bar-qaz-qux/submissions/
 * Status:
