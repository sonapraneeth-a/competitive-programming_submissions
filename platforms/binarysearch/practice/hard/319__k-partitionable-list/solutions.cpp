 ...
 * FILE DESCRIPTION
 *
 *        Filename: 319__k-partitionable-list/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'K-Partitionable List' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/k-partitionable-list/submissions/
 * Status:
