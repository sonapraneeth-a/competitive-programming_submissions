 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1199__playlist-count/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Playlist Count' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/playlist-count/submissions/
 * Status:
 ...
 */
// clang-format on
int solve(int num_songs, int playlist_size, int cycle_length) {
