 ...
 * FILE DESCRIPTION
 *
 *        Filename: 595__decimal-number/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Decimal Number' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/decimal-number/submissions/
 * Status:
