 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1261__minimum-light-radius/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimum Light Radius' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimum-light-radius/submissions/
 * Status:
