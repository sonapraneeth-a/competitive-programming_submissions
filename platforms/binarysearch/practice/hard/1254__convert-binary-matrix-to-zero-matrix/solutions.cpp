 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1254__convert-binary-matrix-to-zero-matrix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Convert Binary Matrix to Zero Matrix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/convert-binary-matrix-to-zero-matrix/submissions/
 * Status:
