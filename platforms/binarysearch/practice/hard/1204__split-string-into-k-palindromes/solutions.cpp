 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1204__split-string-into-k-palindromes/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Split String Into K Palindromes' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/split-string-into-k-palindromes/submissions/
 * Status:
