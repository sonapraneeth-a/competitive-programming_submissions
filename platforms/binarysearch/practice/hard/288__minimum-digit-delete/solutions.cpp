 ...
 * FILE DESCRIPTION
 *
 *        Filename: 288__minimum-digit-delete/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Minimum Digit Delete' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/minimum-digit-delete/submissions/
 * Status:
