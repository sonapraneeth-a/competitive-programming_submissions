 ...
 * FILE DESCRIPTION
 *
 *        Filename: 226__string-expansion/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'String Expansion' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/string-expansion/submissions/
 * Status:
