 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1063__decode-list-message/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Decode List Message' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/decode-list-message/submissions/
 * Status:
