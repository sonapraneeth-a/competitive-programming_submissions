 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1433__continuous-path-to-escape-mines/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Continuous Path to Escape Mines' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/continuous-path-to-escape-mines/submissions/
 * Status:
 ...
 */
// clang-format on
bool solve(vector<vector<int>>& mines, int width) {
