 ...
 * FILE DESCRIPTION
 *
 *        Filename: 524__cut-matrix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Cut Matrix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/cut-matrix/submissions/
 * Status:
