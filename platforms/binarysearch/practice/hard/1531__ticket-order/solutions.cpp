 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1531__ticket-order/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Ticket Order' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/ticket-order/submissions/
 * Status:
 ...
 */
// clang-format on
vector<int> solve(vector<int>& tickets) {
