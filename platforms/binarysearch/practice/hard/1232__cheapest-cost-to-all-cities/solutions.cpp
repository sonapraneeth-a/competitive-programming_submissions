 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1232__cheapest-cost-to-all-cities/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Cheapest Cost to All Cities' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/cheapest-cost-to-all-cities/submissions/
 * Status:
