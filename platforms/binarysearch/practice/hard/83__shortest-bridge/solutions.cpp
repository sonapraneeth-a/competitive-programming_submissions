 ...
 * FILE DESCRIPTION
 *
 *        Filename: 83__shortest-bridge/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Shortest Bridge' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/shortest-bridge/submissions/
 * Status:
