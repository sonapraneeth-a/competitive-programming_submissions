 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1024__maximum-adjacent-absolute-value-sum-after-one-reversal/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Maximum Adjacent Absolute Value Sum After One Reversal' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/maximum-adjacent-absolute-value-sum-after-one-reversal/submissions/
 * Status:
