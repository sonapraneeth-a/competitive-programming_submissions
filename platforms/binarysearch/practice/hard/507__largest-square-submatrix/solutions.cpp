 ...
 * FILE DESCRIPTION
 *
 *        Filename: 507__largest-square-submatrix/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Largest Square Submatrix' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/largest-square-submatrix/submissions/
 * Status:
