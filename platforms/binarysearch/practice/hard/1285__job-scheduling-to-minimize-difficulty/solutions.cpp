 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1285__job-scheduling-to-minimize-difficulty/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Job Scheduling to Minimize Difficulty' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/job-scheduling-to-minimize-difficulty/submissions/
 * Status:
