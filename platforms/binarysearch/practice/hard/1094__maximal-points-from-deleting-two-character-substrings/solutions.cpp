 ...
 * FILE DESCRIPTION
 *
 *        Filename: 1094__maximal-points-from-deleting-two-character-substrings/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Maximal Points From Deleting Two Character Substrings' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/maximal-points-from-deleting-two-character-substrings/submissions/
 * Status:
