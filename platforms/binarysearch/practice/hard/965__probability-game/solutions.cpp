 ...
 * FILE DESCRIPTION
 *
 *        Filename: 965__probability-game/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Probability Game' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/probability-game/submissions/
 * Status:
 ...
 */
// clang-format on
double solve(int n, int k, int h) {
