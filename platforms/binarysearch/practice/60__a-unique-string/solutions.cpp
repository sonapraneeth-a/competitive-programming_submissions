 ...
 * FILE DESCRIPTION
 *
 *        Filename: 60__a-unique-string/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'A Unique String' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/a-unique-string/submissions/
 * Status:
