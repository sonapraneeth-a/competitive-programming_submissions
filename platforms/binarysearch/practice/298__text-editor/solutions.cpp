 ...
 * FILE DESCRIPTION
 *
 *        Filename: 298__text-editor/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Text Editor' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/text-editor/submissions/
 * Status:
