 ...
 * FILE DESCRIPTION
 *
 *        Filename: 958__longest-sublist-with-absolute-difference-condition/solutions.cpp
 *      Created on: 05 September 2021
 *   Last modified: 05 September 2021
 *          Author: sonapraneeth_a
 *     Description: BinarySearch submission for 'Longest Sublist with Absolute Difference Condition' problem
 */
 ...
 *
 * Submission link: https://binarysearch.com/problems/longest-sublist-with-absolute-difference-condition/submissions/
 * Status:
